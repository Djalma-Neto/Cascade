...
# clf1 = cv2.CascadeClassifier('./cascadeMelhor.xml')
# clf1 = cv2.CascadeClassifier('./cascadeMelhor2.xml')
...
for(x,y,w,h) in detecta1:
	...
	cv2.putText(img1, "local".format(), (x,y-20),cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
...
for(x,y,w,h) in detecta3:
	...
	cv2.putText(img3, "local".format(), (x,y-20),cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
